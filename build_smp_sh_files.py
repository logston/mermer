...
MER_CONVERSION_PY_FILE = '/home/araldiel/python-tools/mer_conservation/smp.py'
SEQUENCE_FILE_PATTERN = COMMON_DIR + 'Elisa_2012_07_06/s_{seq_count}_sequence.txt.gz.noadapt'
COUNT_FILE_PATTERN = COMMON_DIR + 'Elisa_2012_07_06/s_{seq_count}_sequence.txt.gz.noadapt.mercount-{mer_count}mer.smp'
...
#$ -l h_vmem=8G                  # Requested Memory
#$ -l h_rt=24:00:00              # Requested CPU time
#$ -pe smp {cpu_count}           # number of cores
#$ -cwd                          #
...
{SEQUENCE_FILE_PATTERN} {mer_count} > \\\n\
{COUNT_FILE_PATTERN} 
"""
